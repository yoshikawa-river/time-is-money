        ...
        <>
            <div className="main">
                <div className="main-content">
                    <InputReward reward={reward} onChange={onChangeReward} placeholder={'時給金額'} startBtnState={btnDisabled.start}/>
                    <Wage inputWage={reward} elapsedTime={elapsedTime} />
